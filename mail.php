...
<!-- ▼************ 送信内容表示部　※編集は自己責任で ************ ▼-->
<div id="formWrap" class="contact_kakunin">
<?php if($empty_flag == 1){ ?>
<div align="center">
<h4>入力にエラーがあります。下記をご確認の上「Back」ボタンにて修正をお願い致します。</h4>
<?php echo $errm; ?><br /><br /><input type="button" value=" Back " class="send_btn" onClick="history.back()">
</div>
<?php }else{ ?>
<h3>送信確認</h3>
</br>
...
<input type="button" value="　Back　" class="send_btn" onClick="history.back()"></p>
</form>
<?php } ?>
</div><!-- /formWrap -->
<!-- ▲ *********** 送信内容確認部　※編集は自己責任で ************ ▲-->
...
<div align="center" class="contact_finish">
<?php if($empty_flag == 1){ ?>
<h4>入力にエラーがあります。下記をご確認の上「Back」ボタンにて修正をお願い致します。</h4>
<div style="color:red"><?php echo $errm; ?></div>
<br /><br /><input type="button" value=" Back " class="send_btn" onClick="history.back()">
</div>
</body>
</html>
<?php }else{ ?>
Thank You!!<br /><br />
Send completely.<br /><br /><br />
<a href="<?php echo $site_top ;?>">Back top-page&raquo;</a>
</div>
<!-- <?php copyright(); ?> -->
